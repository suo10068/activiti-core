        ...
        function ($rootScope, $scope, $translate, $http, $location, $routeParams, $modal, $popover, $timeout, appResourceRoot, ResourceService) {
            ...
            $scope.loadProcess = function () {
                ...
                if ($routeParams.modelHistoryId) {
                    url = ACTIVITI.CONFIG.contextRoot + '/repository/models/' + $routeParams.modelId
                ...
                $http({method: 'GET', url: url}).success(function (data, status, headers, config) {
                    ...
                    $scope.model.bpmn20DownloadUrl = ACTIVITI.CONFIG.contextRoot + '/repository/models/' + $routeParams.modelId +
            ...
            $scope.loadVersions = function () {
                ...
                $http({
                    method: 'GET',
                    url: ACTIVITI.CONFIG.contextRoot + '/repository/models/' + $scope.model.latestModelId + '/history',
                    params: params
